...
class DateComponents: MutableStruct {
    ...
    internal constructor(fromCalendar: Calendar, in_: TimeZone? = null, from: Date? = null, to: Date? = null, with: Set<Calendar.Component>? = null) {
        ...
        val endDate = to
        val components = with
        val platformCal = calendar.platformValue.clone() as java.util.Calendar
    ...
    internal fun createCalendarComponents(): java.util.Calendar {
        val c: java.util.Calendar = (this.calendar?.platformValue ?: java.util.Calendar.getInstance())
        val cal: java.util.Calendar = (c as java.util.Calendar).clone() as java.util.Calendar
        ...
        try {
            ...
            linvoke bl@{
                when (component) {
                    ...
                    Calendar.Component.nanosecond -> return@bl // unsupported
                    Calendar.Component.calendar, Calendar.Component.timeZone -> {
                        // Do nothing
                        return@bl
                    }
