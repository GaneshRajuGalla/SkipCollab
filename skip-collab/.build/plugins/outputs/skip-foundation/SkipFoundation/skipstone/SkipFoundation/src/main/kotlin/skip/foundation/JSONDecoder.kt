...
private class JSONKeyedDecodingContainer<Key>: KeyedDecodingContainerProtocol where Key: CodingKey {
    internal val impl: JSONDecoderImpl
    override val codingPath: Array<CodingKey>
...
private fun decodeAsString(value: Any, forKey: CodingKey? = null, impl: JSONDecoderImpl): String {
    val key = forKey
    val string: String?
    string = if (value is NSNull) null else value.toString()
    if (string == null) {
