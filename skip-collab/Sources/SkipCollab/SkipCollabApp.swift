...
let logger: Logger = Logger(subsystem: "com.ganeshrajugalla", category: "SkipCollab")
...
#if !SKIP
public protocol SkipCollabApp : App {
}

/// The entry point to the SkipCollab app.
/// The concrete implementation is in the SkipCollabApp module.
public extension SkipCollabApp {
    var body: some Scene {
        WindowGroup {
            RootView()
        }
