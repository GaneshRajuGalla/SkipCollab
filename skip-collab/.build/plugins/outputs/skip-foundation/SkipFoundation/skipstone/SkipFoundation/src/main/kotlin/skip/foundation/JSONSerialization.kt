...
open class JSONSerialization {
    ...
    companion object {
        ...
        internal val maximumRecursionDepth = 512

        fun isValidJSONObject(obj: Any): Boolean {
        ...
        internal fun _data(withJSONObject: Any, options: JSONSerialization.WritingOptions, stream: Boolean): Data {
        ...
        fun data(withJSONObject: Any, options: JSONSerialization.WritingOptions = WritingOptions(rawValue = 0U)): Data {
            val value = withJSONObject
            val opt = options
            return _data(withJSONObject = value, options = opt, stream = false)
        }

        fun jsonObject(with: Data, options: JSONSerialization.ReadingOptions = ReadingOptions(rawValue = 0U)): Any {
            val data = with
            val opt = options
            try {
