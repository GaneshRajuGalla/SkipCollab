...
typealias PlatformNumberFormatter = java.text.DecimalFormat

open class NumberFormatter {
    internal open var platformValue: java.text.DecimalFormat

    internal constructor(platformValue: java.text.DecimalFormat) {
    ...
    open var numberStyle: NumberFormatter.Style
        get() = _numberStyle
        set(newValue) {
            var fmt: java.text.DecimalFormat = this.platformValue
            when (newValue) {
    ...
    open var zeroSymbol: String?
        get() = platformValue.decimalFormatSymbols.zeroDigit?.toString()
        set(newValue) {
    ...
    open var minusSign: String?
        get() = platformValue.decimalFormatSymbols.minusSign?.toString()
        set(newValue) {
    ...
    open var decimalSeparator: String?
        get() = platformValue.decimalFormatSymbols.decimalSeparator?.toString()
        set(newValue) {
    ...
    open var currencyDecimalSeparator: String?
        get() = platformValue.decimalFormatSymbols.monetaryDecimalSeparator?.toString()
        set(newValue) {
    ...
    fun Style(rawValue: Int): NumberFormatter.Style? {
    ...
    fun PadPosition(rawValue: Int): NumberFormatter.PadPosition? {
        return when (rawValue) {
    ...
    fun RoundingMode(rawValue: Int): NumberFormatter.RoundingMode? {
        return when (rawValue) {
