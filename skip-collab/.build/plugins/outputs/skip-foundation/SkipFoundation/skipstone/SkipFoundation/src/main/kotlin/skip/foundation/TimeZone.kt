...
typealias PlatformTimeZone = java.util.TimeZone

class TimeZone: Sendable, MutableStruct {
    ...
    internal constructor(platformValue: java.util.TimeZone) {
    ...
    fun localizedName(for_: TimeZone.NameStyle, locale: Locale?): String? {
        val style = for_
        when (style) {
            TimeZone.NameStyle.generic -> return platformValue.toZoneId().getDisplayName(java.time.format.TextStyle.FULL, locale?.platformValue)
            TimeZone.NameStyle.standard -> return platformValue.toZoneId().getDisplayName(java.time.format.TextStyle.FULL_STANDALONE, locale?.platformValue)
            TimeZone.NameStyle.shortStandard -> return platformValue.toZoneId().getDisplayName(java.time.format.TextStyle.SHORT_STANDALONE, locale?.platformValue)
            TimeZone.NameStyle.daylightSaving -> return platformValue.toZoneId().getDisplayName(java.time.format.TextStyle.FULL, locale?.platformValue)
            TimeZone.NameStyle.shortDaylightSaving -> return platformValue.toZoneId().getDisplayName(java.time.format.TextStyle.SHORT, locale?.platformValue)
            TimeZone.NameStyle.shortGeneric -> return platformValue.toZoneId().getDisplayName(java.time.format.TextStyle.SHORT, locale?.platformValue)
        }
    }
    ...
    fun kotlin(nocopy: Boolean = false): java.util.TimeZone = if (nocopy) platformValue else platformValue.clone() as java.util.TimeZone
...
internal fun java.util.TimeZone.swift(nocopy: Boolean = false): TimeZone {
    val platformValue = if (nocopy) this else clone() as java.util.TimeZone
