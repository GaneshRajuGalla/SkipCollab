...
open class CoordinateSpaceProtocol {
    open val coordinateSpace: CoordinateSpace
    ...
    companion object {
        ...
        val local = LocalCoordinateSpace()
        val global = GlobalCoordinateSpace()
    }
}
...
open class NamedCoordinateSpace: CoordinateSpaceProtocol {
    ...
    internal constructor(coordinateSpace: CoordinateSpace): super() {
